...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 27. Mrz 2024 um 12:54
...
(2, 1, 3, 'Tim', 'Schneider', 'Tim@iu-study.org', '$2y$10$k1YtY982FRJ9G4ektHFI.Owgu2bwFgRYYW2qLEqQLeqkORSSDHUMq'),
...
CREATE TABLE `statistik` (
  ...
  `Fragenzahl` int(12) DEFAULT NULL,
  `Punkte` int(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(13, 2, 4, '2024-03-25 13:21:59', 5, 1),
(14, 2, 4, '2024-03-25 13:22:12', 5, 3);
...
--
ALTER TABLE `fragen`
  MODIFY `FragenID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `statistik`
  MODIFY `StatistikID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
